...
# Precisamos apenas do Gyro Z (gz)
...
def process_imu_packet(data_bytes):
    global last_sent_time, yaw_ref, estimated_yaw, last_update_time
    ...
    gz = extract_gyro(data_bytes, sample_index_for_control)
...
async def connect_to_imu():
    global yaw_ref # Declarar global para permitir reset
        ...
        async with BleakClient(IMU_SENSOR_ADDRESS) as client:
            ...
            while True:
                ...
                if user_input.strip().lower() == "q":
                    ...
                    yaw_ref = None
                    # Redefinir também o ângulo estimado para evitar saltos após o reset
